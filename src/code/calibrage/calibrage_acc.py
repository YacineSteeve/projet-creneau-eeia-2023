...
#
def get_accel():
    ax,ay,az = mpu.acceleration # read and convert accel data
    return ax,ay,az
...
def accel_cal():
    ...
    for qq,ax_qq in enumerate(axis_vec):
        ...
        for direc_ii,direc in enumerate(cal_directions):
            ...
            [mpu.acceleration for ii in range(0,cal_size)] # clear buffer between readings
            mpu_array = []
